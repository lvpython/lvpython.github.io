...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhotoSwipe = __webpack_require__(11)
	var PhotoSwipeUI_Default = __webpack_require__(12)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function( window, undefined ) {
	"use strict";
	    function r(r) {
	        if ("undefined" == typeof r) throw new Error('Pathformer [constructor]: "element" parameter is required');
	        if (r.constructor === String && (r = document.getElementById(r), !r)) throw new Error('Pathformer [constructor]: "element" parameter is not related to an existing ID');
	        if (!(r.constructor instanceof window.SVGElement || /^svg$/i.test(r.nodeName))) throw new Error('Pathformer [constructor]: "element" parameter must be a string or a SVGelement');
	    ...
	    var Vivus = {
	      ...
	      docElem: 0,
	      map: [],
	      setElement: function(r, n) {
	        if ("undefined" == typeof r) throw new Error('Vivus [constructor]: "element" parameter is required');
	        if (r.constructor === String && (r = document.getElementById(r), !r)) throw new Error('Vivus [constructor]: "element" parameter is not related to an existing ID');
	        if (n && n.file) {
	        ...
	        if (this.start = e.start || i[0], this.isIE = -1 !== window.navigator.userAgent.indexOf("MSIE"), this.duration = o(e.duration, 120), this.delay = o(e.delay, null), this.dashGap = o(e.dashGap, 2), this.forceRender = e.hasOwnProperty("forceRender") ? !!e.forceRender : this.isIE, this.selfDestroy = !!e.selfDestroy, this.onReady = e.onReady, this.animTimingFunction = e.animTimingFunction || Vivus.LINEAR, this.pathTimingFunction = e.pathTimingFunction || Vivus.LINEAR, this.delay >= this.duration) throw new Error("Vivus [constructor]: delay must be shorter than duration")
	        ...
	        switch (this.start) {
	            ...
	            case "inViewport":
	                var e = this,
	                    r = function() {
	                        e.isInViewport(e.el, 1) && (e.play(), window.removeEventListener("scroll", r))
	                    };
	    ...
	    var i, a, o;
	    Vivus.LINEAR = function(t) {
	        return t
	    }, Vivus.EASE = function(t) {
	        return -Math.cos(t * Math.PI) / 2 + .5
	    }, Vivus.EASE_OUT = function(t) {
	        return 1 - Math.pow(1 - t, 3)
	    }, Vivus.EASE_IN = function(t) {
	        return Math.pow(t, 3)
	    }, Vivus.EASE_OUT_BOUNCE = function(t) {
	        ...
	        var r = parseInt(t, 10);
	        return r >= 0 ? r : e
	    },// Expose Vivus to the global object
	window.Vivus = Vivus;

	if ( "function" === "function" && __webpack_require__(2) && __webpack_require__(2).Vivus ) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () { return Vivus; }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	}
